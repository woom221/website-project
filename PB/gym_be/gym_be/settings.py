"""
Django settings for gym_be project.
...
SECRET_KEY = 'django-insecure-2mj4@d4eyi4@cbk6p*onpeeexh3us6a@*^atsy$%7%thiptep='
...
WSGI_APPLICATION = 'gym_be.wsgi.application'
